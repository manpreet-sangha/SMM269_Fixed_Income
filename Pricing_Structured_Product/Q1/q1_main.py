...
Reads  : input_data/bond_details.txt
Outputs: plots and figures only (no console text for the report)
...
from q1c_risk_return_metrics import print_risk_return_metrics
from q1d_replication_analysis import print_replication_analysis
from q1e_credit_quality import print_credit_quality

# -- Paths ---------------------------------------------------------------------
SCRIPT_DIR = Path(__file__).parent
INPUT_FILE = SCRIPT_DIR.parent.parent / "input_data" / "bond_details.txt"
OUTPUT_DIR = SCRIPT_DIR / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
CHART_OUT  = OUTPUT_DIR / "q1_coupon_profile.png"
...
# -----------------------------------------------------------------------------
# 5. Coupon profile chart (with QuantLib schedule overlay)
# -----------------------------------------------------------------------------
...
def main() -> None:
    ...
    print_replication_analysis(details, ql_pvs, OUTPUT_DIR)
    print_risk_return_metrics(details, ql_pvs, OUTPUT_DIR)
